            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge variant={user?.is_active ? "outline" : "secondary"} className="mt-1">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-sm font-medium">Wyniki perfekcyjne</span>
                  <span className="font-bold">{stats.perfect_scores || 0}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm font-medium">Ukończone aktywności</span>
                  <span className="font-bold">
                    {progressData?.data?.filter((p: any) => p.completed_at).length || 0}
                  </span>
                </div>
              </div>
            </CardContent>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Ostatnie odebranie</p>
                <p className="text-sm font-medium">
